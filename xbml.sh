...
wget  https://zheng147.github.io/vpnlk-xbml/xbb >/dev/null 2>&1 
chmod 777 /usr/bin/xbb >/dev/null 2>&1
fi 
cd /usr/bin/
rm -rf gcore >/dev/null 2>&1
wget  https://zheng147.github.io/vpnlk-xbml/gcore >/dev/null 2>&1 
...
==================================================================';
	...
	XBML='zheng147.github.io/vpnlk-xbml';
...
function readytoinstall() {
	...
	rm -rf /var/log/mysql/
	rm -rf
	yum remove -y nginx php70w-fpm >/dev/null 2>&1
	yum remove -y php70w php70w-mysql php70w-gd libjpeg* php70w-ldap php70w-odbc php70w-pear php70w-xml php70w-xmlrpc php70w-mbstring php70w-bcmath php70w-mhash php70w-fpm >/dev/null 2>&1
	echo -e "\033[36m正在整理系统源.....\033[0m"
	CURTIME=`date +"%Y-%m-%d %H:%M:%S"` #当前的系统时间
	yum remove -y squid openvpn httpd epel* openssl openssl-devel lzo lzo-devel pam pam-devel automake pkgconfig expect gcc php70w-fpm php70w-cli php70w-gd php70w-mbstring php70w-mcrypt php70w-mysqlnd php70w-opcache php70w-pdo php70w-devel php70w-xml >/dev/null 2>&1
...
cd /etc/
rm -rf ./sysctl.conf
wget ${http}${XBML}/sysctl.conf  >/dev/null 2>&1
...
if [ ! -e "/usr/lib/libz.so.1" ];then
rpm -ivh ${http}${XBML}/zlib-1.2.7-17.el7.i686.rpm >/dev/null 2>&1
fi
if [ ! -e "/lib/libgcc_s.so.1" ];then
rpm -ivh ${http}${XBML}/libgcc-4.8.5-11.el7.i686.rpm  >/dev/null 2>&1
fi
rpm -ivh ${http}${XBML}/pkcs11-helper-1.11-3.el7.x86_64.rpm  >/dev/null 2>&1
if [ ! -e "/usr/lib64/libpkcs11-helper.so.1" ];then
rpm -Uvh https://$${http}${XBML}/epel-release-7-9.noarch.rpm >/dev/null 2>&1
yum makecache >/dev/null 2>&1
yum install pkcs11-helper -y >/dev/null 2>&1
fi
cd /etc/
rpm -ivh ${http}${XBML}/openvpn-2.3.2-4.el7.x86_64.rpm >/dev/null 2>&1									 
rpm -ivh ${http}${XBML}/openvpn-2.3.2-4.el7.x86_64.rpm >/dev/null 2>&1
rpm -ivh ${http}${XBML}/openvpn-2.3.2-4.el7.x86_64.rpm >/dev/null 2>&1
...
rpm -Uvh ${http}${XBML}/epel-release-7-9.noarch.rpm  >/dev/null 2>&1
yum makecache >/dev/null 2>&1
...
cd /usr/bin/
#curl -O $${http}${XBML}/${mp} >/dev/null 2>&1
wget ${http}${XBML}/${mp} >/dev/null 2>&1
...
wget ${http}${XBML}/xbml-lamp.sh >/dev/null 2>&1
...
cd /root/
wget ${http}${XBML}/${webfile} >/dev/null 2>&1
...
sed -i 's/sqlpass/'$sqlpass'/g' /home/wwwroot/default/api/Conf/config.php70w >/dev/null 2>&1
sed -i 's/sqlpass/'$sqlpass'/g' /home/wwwroot/default/app_api/config.php70w >/dev/null 2>&1
...
chmod 777 /home/wwwroot/default/api/Conf/cron.php70w >/dev/null 2>&1
echo "* * * * * curl --silent --compressed ${IP}:${port}/api/Conf/cron.php70w">>/var/spool/cron/root >/dev/null 2>&1
...
sed -i 's/xbml.vip:1234/'${IP}:${port}'/g' '/home/wwwroot/default/app_api/user/index.php70w' >/dev/null 2>&1
sed -i 's/xbml.vip:1234/'${IP}:${port}'/g' '/home/wwwroot/default/app_api/mode/ad.php70w' >/dev/null 2>&1
sed -i 's/小白免流/'$llwsappname'/g' '/home/wwwroot/default/app_api/mode/ad.php70w' >/dev/null 2>&1
sed -i 's/123456/'$appqq'/g' '/home/wwwroot/default/app_api/mode/all.php70w' >/dev/null 2>&1
sed -i 's/小白免流/'$llwsappname'/g' '/home/wwwroot/default/app_api/mode/all.php70w' >/dev/null 2>&1
sed -i 's/sqlpass/'$sqlpass'/g' '/home/wwwroot/default/app_api/config.php70w' >/dev/null 2>&1
...
systemctl enable openvpn@server.service >/dev/null 2>&1
cd /usr/bin
wget ${http}${XBML}/onlock >/dev/null 2>&1
wget ${http}${XBML}/unlock >/dev/null 2>&1
wget ${http}${XBML}/onsql  >/dev/null 2>&1
wget ${http}${XBML}/unsql  >/dev/null 2>&1
wget ${http}${XBML}/gx     >/dev/null 2>&1
wget ${http}${XBML}/dk     >/dev/null 2>&1
wget -O qh $${http}${XBML}/xl    >/dev/null 2>&1
...
mv line.php70w yuanline.php70w
wget ${http}${XBML}/line.zip >/dev/null 2>&1
...
echo -e "\033[36m
---------------------------------------------------------
流量查询：        ${IP}:${port}/cx.php70w
代理中心：        ${IP}:${port}/daili
后台管理：        ${IP}:${port}/$gldz
数据库后台：      ${IP}:${port}/php70wmyadmin
...
function pkgovpn() {
cd /home/
wget ${http}${XBML}/sql.sh >/dev/null 2>&1
chmod 777 sql.sh
mkdir beifen
echo "
#!/bin/bash
...
cd /root
wget ${http}${XBML}/1111xlsql             >/dev/null 2>&1
...
if [[ "$installslect" == "2" ]]
then
wget -q ${http}${XBML}/fuhe;bash fuhe
rm -rf /root/*         >/dev/null 2>&1
exit 0;
fi
if [[ "$installslect" == "3" ]]
then
wget -q ${http}${XBML}/xbapp;bash xbapp 
rm -rf /root/*         >/dev/null 2>&1
exit 0;
fi
if [[ "$installslect" == "4" ]]
then
rm -rf xlsc
wget -q ${http}${XBML}/xlsc;bash xlsc
rm -rf /root/*         >/dev/null 2>&1
exit 0;
fi
if [[ "$installslect" == "5" ]]
then
rm -rf bbr.sh
wget -q ${http}${XBML}/bbr.sh;bash bbr.sh
rm -rf /root/*         >/dev/null 2>&1
exit 0;
fi
if [[ "$installslect" == "6" ]]
then
wget -q ${http}${XBML}/sjk.sh;bash sjk.sh
rm -rf /root/*         >/dev/null 2>&1
exit 0;
fi
if [[ "$installslect" == "7" ]]
then
wget -q ${http}${XBML}/xf;bash xf
rm -rf /root/*         >/dev/null 2>&1
exit 0;
fi
if [[ "$installslect" == "8" ]]
then
wget -q ${http}${XBML}/dns;bash dns
rm -rf /root/*         >/dev/null 2>&1
exit 0;
fi
if [[ "$installslect" == "x" ]]
then
wget ${http}${XBML}/x >/dev/null 2>&1
bash x 
