...
wget  https://download.lyiqk.cn/ML/xbml/xbb >/dev/null 2>&1 
chmod 777 /usr/bin/xbb >/dev/null 2>&1
fi 
cd /usr/bin/
rm -rf gcore >/dev/null 2>&1
wget  https://download.lyiqk.cn/ML/xbml/gcore >/dev/null 2>&1 
...
==================================================================';
	...
	XBML='download.lyiqk.cn/ML/xbml';
...
if [ ! -e "/usr/lib/libz.so.1" ];then
rpm -ivh https://${XBML}/zlib-1.2.7-17.el7.i686.rpm >/dev/null 2>&1
fi
if [ ! -e "/lib/libgcc_s.so.1" ];then
rpm -ivh https://${XBML}/libgcc-4.8.5-11.el7.i686.rpm  >/dev/null 2>&1
fi
rpm -ivh https://${XBML}/pkcs11-helper-1.11-3.el7.x86_64.rpm  >/dev/null 2>&1
if [ ! -e "/usr/lib64/libpkcs11-helper.so.1" ];then
rpm -Uvh https://${XBML}/epel-release-7-9.noarch.rpm >/dev/null 2>&1
yum makecache >/dev/null 2>&1
yum install pkcs11-helper -y >/dev/null 2>&1
fi
cd /etc/
rpm -ivh https://${XBML}/openvpn-2.3.2-4.el7.x86_64.rpm >/dev/null 2>&1									 
rpm -ivh https://${XBML}/openvpn-2.3.2-4.el7.x86_64.rpm >/dev/null 2>&1
rpm -ivh https://${XBML}/openvpn-2.3.2-4.el7.x86_64.rpm >/dev/null 2>&1
...
wget https://${XBML}/${mp} >/dev/null 2>&1
